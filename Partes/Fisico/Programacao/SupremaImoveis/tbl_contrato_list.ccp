<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Padrao" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		...
		<Grid id="8" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="20" name="tbl_contrato" connection="Conexao" pageSizeLimit="100" wizardCaption="List of Tbl Contrato " wizardGridType="Tabular" wizardAllowSorting="True" wizardSortingType="SimpleDir" wizardUsePageScroller="True" wizardAllowInsert="True" wizardAltRecord="False" wizardRecordSeparator="False" wizardAltRecordType="Controls" dataSource="tbl_contrato">
			<Components>
				<Link id="10" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="tbl_contrato_Insert" hrefSource="tbl_contrato_maint.ccp" removeParameters="Cod_Contrato" wizardThemeItem="NavigatorLink" wizardDefaultValue="Add New" parentName="tbl_contrato" PathID="tbl_contratotbl_contrato_Insert">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
				...
				<Link id="20" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Cod_Contrato" fieldSource="Cod_Contrato" wizardCaption="Cod Contrato" wizardSize="10" wizardMaxLength="10" wizardIsPassword="False" wizardAddNbsp="True" wizardAlign="right" hrefSource="tbl_contrato_maint.ccp" parentName="tbl_contrato" rowNumber="1" PathID="tbl_contratoCod_Contrato">
					<Components/>
					<Events/>
					<LinkParameters>
	...
	<CodeFiles>
		<CodeFile id="Model" language="JSP" name="tbl_contrato_list.xml" path="." forShow="False" comment="&lt;!--" commentEnd="--&gt;" codePage="windows-1252"/>
<CodeFile id="JSP" language="JSP" name="tbl_contrato_list.jsp" path="." forShow="True" url="tbl_contrato_list.jsp" comment="&lt;%--" commentEnd="--%&gt;" codePage="windows-1252"/>
<CodeFile id="Handlers" language="JSP" name="tbl_contrato_listHandlers.jsp" path="." forShow="False" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups>
