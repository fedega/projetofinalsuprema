<%--JSP Page Init @1-78D159DC--%>
<%@page import="com.codecharge.*,com.codecharge.components.*,com.codecharge.util.*,com.codecharge.events.*,com.codecharge.db.*,com.codecharge.validation.*,java.util.*,java.io.*,com.codecharge.util.cache.CacheEvent,com.codecharge.util.cache.ICache,com.codecharge.template.*"%>
<%if ((new tbl_tipo_causul_listServiceChecker()).check(request, response, getServletContext())) return;%>
<%@page contentType="text/html; charset=windows-1252"%>
<%@taglib uri="/ccstags" prefix="ccs"%>
<%--End JSP Page Init--%>

<%--Page Body @1-B0E0545F--%>
<%@include file="tbl_tipo_causul_listHandlers.jsp"%>
<%
    if (!tbl_tipo_causul_listModel.isVisible()) return;
    ...
    pageContext.setAttribute("parent", tbl_tipo_causul_listModel);
    pageContext.setAttribute("page", tbl_tipo_causul_listModel);
    tbl_tipo_causul_listModel.fireOnInitializeViewEvent(new Event());
    tbl_tipo_causul_listModel.fireBeforeShowEvent(new Event());
    if (!tbl_tipo_causul_listModel.isVisible()) return;
%>
<%--End Page Body--%>
...
<%--JSP Page BeforeOutput @1-DAB57B53--%>
<%tbl_tipo_causul_listModel.fireBeforeOutputEvent();%>
<%--End JSP Page BeforeOutput--%>

<%--JSP Page Unload @1-35C385AD--%>
<%tbl_tipo_causul_listModel.fireBeforeUnloadEvent();%>
<%--End JSP Page Unload--%>
