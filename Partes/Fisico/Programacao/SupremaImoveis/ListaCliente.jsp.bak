<%--JSP Page Init @1-093FFC32--%>
<%@page import="com.codecharge.*,com.codecharge.components.*,com.codecharge.util.*,com.codecharge.events.*,com.codecharge.db.*,com.codecharge.validation.*,java.util.*,java.io.*,com.codecharge.util.cache.CacheEvent,com.codecharge.util.cache.ICache,com.codecharge.template.*"%>
<%if ((new ListaClienteServiceChecker()).check(request, response, getServletContext())) return;%>
<%@page contentType="text/html; charset=windows-1252"%>
<%@taglib uri="/ccstags" prefix="ccs"%>
<%--End JSP Page Init--%>

<%--Page Body @1-9AB937D7--%>
<%@include file="ListaClienteHandlers.jsp"%>
<%
    if (!ListaClienteModel.isVisible()) return;
    if (ListaClienteParent != null) {
        if (!ListaClienteParent.getChild(ListaClienteModel.getName()).isVisible()) return;
    }
    pageContext.setAttribute("parent", ListaClienteModel);
    pageContext.setAttribute("page", ListaClienteModel);
    ListaClienteModel.fireOnInitializeViewEvent(new Event());
    ListaClienteModel.fireBeforeShowEvent(new Event());
    if (!ListaClienteModel.isVisible()) return;
%>
<%--End Page Body--%>

<%--JSP Page Content @1-A5F73C08--%>
...
<%--JSP Page BeforeOutput @1-7356D4E5--%>
<%ListaClienteModel.fireBeforeOutputEvent();%>
<%--End JSP Page BeforeOutput--%>

<%--JSP Page Unload @1-9C202A1B--%>
<%ListaClienteModel.fireBeforeUnloadEvent();%>
<%--End JSP Page Unload--%>
