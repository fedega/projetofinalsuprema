<%--JSP Page Init @1-B7726F3A--%>
<%@page import="com.codecharge.*,com.codecharge.components.*,com.codecharge.util.*,com.codecharge.events.*,com.codecharge.db.*,com.codecharge.validation.*,java.util.*,java.io.*,com.codecharge.util.cache.CacheEvent,com.codecharge.util.cache.ICache,com.codecharge.template.*"%>
<%if ((new DesempenhoFuncionarioServiceChecker()).check(request, response, getServletContext())) return;%>
<%@page contentType="text/html; charset=windows-1252"%>
<%@taglib uri="/ccstags" prefix="ccs"%>
<%--End JSP Page Init--%>

<%--Page Body @1-4A1D5DAC--%>
<%@include file="DesempenhoFuncionarioHandlers.jsp"%>
<%
    if (!DesempenhoFuncionarioModel.isVisible()) return;
    ...
    pageContext.setAttribute("parent", DesempenhoFuncionarioModel);
    pageContext.setAttribute("page", DesempenhoFuncionarioModel);
    DesempenhoFuncionarioModel.fireOnInitializeViewEvent(new Event());
    DesempenhoFuncionarioModel.fireBeforeShowEvent(new Event());
    if (!DesempenhoFuncionarioModel.isVisible()) return;
%>
<%--End Page Body--%>

<%--JSP Page Content @1-283A6D51--%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<ccs:meta header="Content-Type"/>
<title>Desempenho de Funcionarios</title>
...
<%--JSP Page BeforeOutput @1-5B0BB38A--%>
<%DesempenhoFuncionarioModel.fireBeforeOutputEvent();%>
<%--End JSP Page BeforeOutput--%>

<%--JSP Page Unload @1-B47D4D74--%>
<%DesempenhoFuncionarioModel.fireBeforeUnloadEvent();%>
<%--End JSP Page Unload--%>
