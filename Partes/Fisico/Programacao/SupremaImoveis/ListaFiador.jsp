<%--JSP Page Init @1-106AB533--%>
<%@page import="com.codecharge.*,com.codecharge.components.*,com.codecharge.util.*,com.codecharge.events.*,com.codecharge.db.*,com.codecharge.validation.*,java.util.*,java.io.*,com.codecharge.util.cache.CacheEvent,com.codecharge.util.cache.ICache,com.codecharge.template.*"%>
<%if ((new ListaFiadorServiceChecker()).check(request, response, getServletContext())) return;%>
<%@page contentType="text/html; charset=windows-1252"%>
<%@taglib uri="/ccstags" prefix="ccs"%>
<%--End JSP Page Init--%>

<%--Page Body @1-2E7E9F4D--%>
<%@include file="ListaFiadorHandlers.jsp"%>
<%
    if (!ListaFiadorModel.isVisible()) return;
    if (ListaFiadorParent != null) {
        if (!ListaFiadorParent.getChild(ListaFiadorModel.getName()).isVisible()) return;
    }
    pageContext.setAttribute("parent", ListaFiadorModel);
    pageContext.setAttribute("page", ListaFiadorModel);
    ListaFiadorModel.fireOnInitializeViewEvent(new Event());
    ListaFiadorModel.fireBeforeShowEvent(new Event());
    if (!ListaFiadorModel.isVisible()) return;
%>
<%--End Page Body--%>

<%--JSP Page Content @1-D2F42B8C--%>
...
<%--JSP Page BeforeOutput @1-CCF25894--%>
<%ListaFiadorModel.fireBeforeOutputEvent();%>
<%--End JSP Page BeforeOutput--%>

<%--JSP Page Unload @1-2384A66A--%>
<%ListaFiadorModel.fireBeforeUnloadEvent();%>
<%--End JSP Page Unload--%>
