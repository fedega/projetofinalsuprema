<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Padrao" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		...
		<Grid id="6" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="20" name="tbl_solicitacoes" connection="Conexao" pageSizeLimit="100" wizardCaption="List of Tbl Solicitacoes " wizardGridType="Tabular" wizardAllowSorting="True" wizardSortingType="SimpleDir" wizardUsePageScroller="True" wizardAllowInsert="True" wizardAltRecord="False" wizardRecordSeparator="False" wizardAltRecordType="Controls" dataSource="tbl_solicitacoes">
			<Components>
				<Link id="8" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="tbl_solicitacoes_Insert" hrefSource="ManterSolicitacoes.ccp" removeParameters="Cod_Solicitacoes" wizardThemeItem="NavigatorLink" wizardDefaultValue="Add New" parentName="tbl_solicitacoes" PathID="tbl_solicitacoestbl_solicitacoes_Insert">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
				...
				<Link id="16" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Cod_Solicitacoes" fieldSource="Cod_Solicitacoes" wizardCaption="Cod Solicitacoes" wizardSize="10" wizardMaxLength="10" wizardIsPassword="False" wizardAddNbsp="True" wizardAlign="right" hrefSource="ManterSolicitacoes.ccp" parentName="tbl_solicitacoes" rowNumber="1" PathID="tbl_solicitacoesCod_Solicitacoes">
					<Components/>
					<Events/>
					<LinkParameters>
	...
	<CodeFiles>
		<CodeFile id="Model" language="JSP" name="ListaSolicitacoes.xml" path="." forShow="False" comment="&lt;!--" commentEnd="--&gt;" codePage="windows-1252"/>
<CodeFile id="JSP" language="JSP" name="ListaSolicitacoes.jsp" path="." forShow="True" url="ListaSolicitacoes.jsp" comment="&lt;%--" commentEnd="--%&gt;" codePage="windows-1252"/>
<CodeFile id="Handlers" language="JSP" name="ListaSolicitacoesHandlers.jsp" path="." forShow="False" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups>
