<%--JSP Page Init @1-ADC68CB6--%>
<%@page import="com.codecharge.*,com.codecharge.components.*,com.codecharge.util.*,com.codecharge.events.*,com.codecharge.db.*,com.codecharge.validation.*,java.util.*,java.io.*,com.codecharge.util.cache.CacheEvent,com.codecharge.util.cache.ICache,com.codecharge.template.*"%>
<%if ((new ManterAluguelServiceChecker()).check(request, response, getServletContext())) return;%>
<%@page contentType="text/html; charset=windows-1252"%>
<%@taglib uri="/ccstags" prefix="ccs"%>
<%--End JSP Page Init--%>

<%--Page Body @1-E2ECF471--%>
<%@include file="ManterAluguelHandlers.jsp"%>
<%
    if (!ManterAluguelModel.isVisible()) return;
    if (ManterAluguelParent != null) {
        if (!ManterAluguelParent.getChild(ManterAluguelModel.getName()).isVisible()) return;
    }
    pageContext.setAttribute("parent", ManterAluguelModel);
    pageContext.setAttribute("page", ManterAluguelModel);
    ManterAluguelModel.fireOnInitializeViewEvent(new Event());
    ManterAluguelModel.fireBeforeShowEvent(new Event());
    if (!ManterAluguelModel.isVisible()) return;
%>
<%--End Page Body--%>

<%--JSP Page Content @1-A2EE05BA--%>
...
<%--JSP Page BeforeOutput @1-4C435073--%>
<%ManterAluguelModel.fireBeforeOutputEvent();%>
<%--End JSP Page BeforeOutput--%>

<%--JSP Page Unload @1-A335AE8D--%>
<%ManterAluguelModel.fireBeforeUnloadEvent();%>
<%--End JSP Page Unload--%>
