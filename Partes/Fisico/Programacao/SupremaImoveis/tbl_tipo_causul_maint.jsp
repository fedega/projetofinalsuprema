...
//tbl_tipo_causulaButton_Delete_OnClick @5-E516C012
function tbl_tipo_causulaButton_Delete_OnClick()
{
    disableValidation = true;
}
//End tbl_tipo_causulaButton_Delete_OnClick

//bind_events @1-23C7E670
function bind_events() {
    if (functionExists("Header_bind_events")) Header_bind_events();
    if (functionExists("Footer_bind_events")) Footer_bind_events();
    addEventHandler("tbl_tipo_causulaButton_Delete", "click", tbl_tipo_causulaButton_Delete_OnClick);
}
//End bind_events
