...
//tbl_tipo_docButton_Delete_OnClick @5-5C3D3A55
function tbl_tipo_docButton_Delete_OnClick()
{
    disableValidation = true;
}
//End tbl_tipo_docButton_Delete_OnClick

//bind_events @1-787AD1AA
function bind_events() {
    if (functionExists("Header_bind_events")) Header_bind_events();
    if (functionExists("Footer_bind_events")) Footer_bind_events();
    addEventHandler("tbl_tipo_docButton_Delete", "click", tbl_tipo_docButton_Delete_OnClick);
}
//End bind_events
