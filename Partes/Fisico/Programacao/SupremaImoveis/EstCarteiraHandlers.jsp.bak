        ...
        public boolean check ( HttpServletRequest request, HttpServletResponse response, ServletContext context) {
            ...
            if ( "FlashChart1".equals ( attr ) ) {
                ...
                command.setSql( "SELECT *  \n"
                            + "FROM `estatistica carteira` {SQL_Where} {SQL_OrderBy}" );
                ...
                if ( ! ds.hasErrors() ) {
                    ...
                    if (records.hasMoreElements()) {
                        ...
                        while (records.hasMoreElements()) {
                            ...
                            tmpl.setTag("main/Row", "@EmAndamentoAlu", ""+record.get("EmAndamentoAlu") );
                            tmpl.setTag("main/Row", "@alugado", ""+record.get("alugado") );
                            tmpl.setTag("main/Row", "@DisponivelAlu", ""+record.get("DisponivelAlu") );
                            tmpl.setTag("main/Row", "@CanceladoAlu", ""+record.get("CanceladoAlu") );
                            tmpl.setTag("main/Row", "@EmAndamentoVenda", ""+record.get("EmAndamentoVenda") );
                            tmpl.setTag("main/Row", "@Vendido", ""+record.get("Vendido") );
                            tmpl.setTag("main/Row", "@DisponivelVenda", ""+record.get("DisponivelVenda") );
                            tmpl.setTag("main/Row", "@CanceladoVenda", ""+record.get("CanceladoVenda") );
