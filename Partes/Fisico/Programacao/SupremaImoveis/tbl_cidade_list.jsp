...
<form id="tbl_cidadeSearch" method="post" action="<ccs:form_action/>" name="<ccs:form_name/>">
      ...
      <td valign="top">
        <table cellspacing="0" cellpadding="0" border="0" class="Header">
          <tr>
            ...
            <td class="th"><strong>Buscar Tbl Cidade </strong></td> 
        ...
        <table class="Record" cellspacing="0" cellpadding="0">
          ...
          <tr class="Controls">
            ...
            <td><input type="text" name="<ccs:control name='s_Nome' property='name'/>" value="<ccs:control name='s_Nome'/>" maxlength="40" size="40" id="tbl_cidadeSearchs_Nome"></td> 
          </tr>
 
          <tr class="Bottom">
            <td colspan="2" align="right">
              <ccs:button name='Button_DoSearch'><input name="<ccs:control name='Button_DoSearch' property='name'/>" type="submit" value="Buscar" alt="Buscar" id="tbl_cidadeSearchButton_DoSearch" class="Button"></ccs:button></td> 
          </tr>
  ...
  <tr>
    <td valign="top">
      <table cellspacing="0" cellpadding="0" border="0" class="Header">
        <tr>
          <td class="HeaderLeft"><img border="0" src="Styles/Padrao/Images/Spacer.gif" alt=""></td> 
          <td class="th"><strong>List of Tbl Cidade</strong></td> 
          <td class="HeaderRight"><img border="0" src="Styles/Padrao/Images/Spacer.gif" alt=""></td> 
        </tr>
      ...
      <table class="Grid" cellspacing="0" cellpadding="0">
        <tr class="Caption">
          <th scope="col">
          <ccs:sorter name='Sorter_Cod_Cidade' column='Cod_Cidade'><a href="<ccs:sorter_href/>" id="tbl_cidadeSorter_Cod_Cidade">Cod Cidade</a> 
          ...
          <th scope="col">
          <ccs:sorter name='Sorter_Cod_Estado' column='Cod_Estado'><a href="<ccs:sorter_href/>" id="tbl_cidadeSorter_Cod_Estado">Cod Estado</a> 
          <ccs:asc_on><img border="0" src="Styles/Padrao/Images/Asc.gif" alt="Ascending"></ccs:asc_on>
          <ccs:desc_on><img border="0" src="Styles/Padrao/Images/Desc.gif" alt="Descending"></ccs:desc_on></ccs:sorter></th>
        ...
        <tr class="Footer">
          <td colspan="3"><a href="<ccs:control name='tbl_cidade_Insert' property='href'/>" id="tbl_cidadetbl_cidade_Insert">Add New</a>&nbsp; 
