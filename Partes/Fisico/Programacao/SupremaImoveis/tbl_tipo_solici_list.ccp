<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Padrao" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Record id="2" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="tbl_tipo_solicitacaoSearch" returnPage="tbl_tipo_solici_list.ccp" wizardCaption="Buscar Tbl Tipo Solicitacao " wizardOrientation="Vertical" wizardFormMethod="post" PathID="tbl_tipo_solicitacaoSearch">
			<Components>
		...
		<Grid id="6" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="20" name="tbl_tipo_solicitacao" connection="Conexao" pageSizeLimit="100" wizardCaption="List of Tbl Tipo Solicitacao " wizardGridType="Tabular" wizardAllowSorting="True" wizardSortingType="SimpleDir" wizardUsePageScroller="True" wizardAllowInsert="True" wizardAltRecord="False" wizardRecordSeparator="False" wizardAltRecordType="Controls" dataSource="tbl_tipo_solicitacao">
			<Components>
				<Link id="8" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="tbl_tipo_solicitacao_Insert" hrefSource="tbl_tipo_solici_maint.ccp" removeParameters="Cod_Solicitacao" wizardThemeItem="NavigatorLink" wizardDefaultValue="Add New" parentName="tbl_tipo_solicitacao" PathID="tbl_tipo_solicitacaotbl_tipo_solicitacao_Insert">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
				...
				<Link id="13" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Cod_Solicitacao" fieldSource="Cod_Solicitacao" wizardCaption="Cod Solicitacao" wizardSize="10" wizardMaxLength="10" wizardIsPassword="False" wizardAddNbsp="True" wizardAlign="right" hrefSource="tbl_tipo_solici_maint.ccp" parentName="tbl_tipo_solicitacao" rowNumber="1" PathID="tbl_tipo_solicitacaoCod_Solicitacao">
					<Components/>
					<Events/>
					<LinkParameters>
	...
	<CodeFiles>
		<CodeFile id="Model" language="JSP" name="tbl_tipo_solici_list.xml" path="." forShow="False" comment="&lt;!--" commentEnd="--&gt;" codePage="windows-1252"/>
<CodeFile id="JSP" language="JSP" name="tbl_tipo_solici_list.jsp" path="." forShow="True" url="tbl_tipo_solici_list.jsp" comment="&lt;%--" commentEnd="--%&gt;" codePage="windows-1252"/>
<CodeFile id="Handlers" language="JSP" name="tbl_tipo_solici_listHandlers.jsp" path="." forShow="False" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups>
