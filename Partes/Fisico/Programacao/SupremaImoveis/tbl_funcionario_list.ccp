<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Padrao" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Record id="2" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="tbl_funcionarioSearch" returnPage="tbl_funcionario_list.ccp" wizardCaption="Buscar Tbl Funcionario " wizardOrientation="Vertical" wizardFormMethod="post" PathID="tbl_funcionarioSearch">
			<Components>
		...
		<Grid id="8" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="20" name="tbl_funcionario" connection="Conexao" pageSizeLimit="100" wizardCaption="List of Tbl Funcionario " wizardGridType="Tabular" wizardAllowSorting="True" wizardSortingType="SimpleDir" wizardUsePageScroller="True" wizardAllowInsert="True" wizardAltRecord="False" wizardRecordSeparator="False" wizardAltRecordType="Controls" dataSource="tbl_funcionario, tbl_estado, tbl_cidade, tbl_orgaoemissor" activeCollection="TableParameters">
			<Components>
				<Link id="10" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="tbl_funcionario_Insert" hrefSource="tbl_funcionario_maint.ccp" removeParameters="Cod_Funcionario" wizardThemeItem="NavigatorLink" wizardDefaultValue="Add New" parentName="tbl_funcionario" PathID="tbl_funcionariotbl_funcionario_Insert">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
				...
				<Link id="28" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Cod_Funcionario" fieldSource="Cod_Funcionario" wizardCaption="Cod Funcionario" wizardSize="10" wizardMaxLength="10" wizardIsPassword="False" wizardAddNbsp="True" wizardAlign="right" hrefSource="tbl_funcionario_maint.ccp" parentName="tbl_funcionario" rowNumber="1" PathID="tbl_funcionarioCod_Funcionario">
					<Components/>
					<Events/>
					<LinkParameters>
	...
	<CodeFiles>
		<CodeFile id="Model" language="JSP" name="tbl_funcionario_list.xml" path="." forShow="False" comment="&lt;!--" commentEnd="--&gt;" codePage="windows-1252"/>
		<CodeFile id="JSP" language="JSP" name="tbl_funcionario_list.jsp" path="." forShow="True" url="tbl_funcionario_list.jsp" comment="&lt;%--" commentEnd="--%&gt;" codePage="windows-1252"/>
		<CodeFile id="Handlers" language="JSP" name="tbl_funcionario_listHandlers.jsp" path="." forShow="False" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
