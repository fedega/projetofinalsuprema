<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="Padrao" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		...
		<Grid id="10" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="20" name="tbl_cliente" connection="Conexao" pageSizeLimit="100" wizardCaption="List of Tbl Cliente " wizardGridType="Tabular" wizardAllowSorting="True" wizardSortingType="SimpleDir" wizardUsePageScroller="True" wizardAllowInsert="True" wizardAltRecord="False" wizardRecordSeparator="False" wizardAltRecordType="Controls" dataSource="tbl_cliente">
			<Components>
				<Link id="12" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="tbl_cliente_Insert" hrefSource="tbl_cliente_maint.ccp" removeParameters="Cod_Cliente" wizardThemeItem="NavigatorLink" wizardDefaultValue="Add New" parentName="tbl_cliente" PathID="tbl_clientetbl_cliente_Insert">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
				...
				<Link id="34" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Cod_Cliente" fieldSource="Cod_Cliente" wizardCaption="Cod Cliente" wizardSize="10" wizardMaxLength="10" wizardIsPassword="False" wizardAddNbsp="True" wizardAlign="right" hrefSource="tbl_cliente_maint.ccp" parentName="tbl_cliente" rowNumber="1" PathID="tbl_clienteCod_Cliente">
					<Components/>
					<Events/>
					<LinkParameters>
	...
	<CodeFiles>
		<CodeFile id="Model" language="JSP" name="tbl_cliente_list.xml" path="." forShow="False" comment="&lt;!--" commentEnd="--&gt;" codePage="windows-1252"/>
<CodeFile id="JSP" language="JSP" name="tbl_cliente_list.jsp" path="." forShow="True" url="tbl_cliente_list.jsp" comment="&lt;%--" commentEnd="--%&gt;" codePage="windows-1252"/>
<CodeFile id="Handlers" language="JSP" name="tbl_cliente_listHandlers.jsp" path="." forShow="False" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups>
