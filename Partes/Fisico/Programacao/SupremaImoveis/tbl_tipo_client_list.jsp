<%--JSP Page Init @1-BFB4FDDA--%>
<%@page import="com.codecharge.*,com.codecharge.components.*,com.codecharge.util.*,com.codecharge.events.*,com.codecharge.db.*,com.codecharge.validation.*,java.util.*,java.io.*,com.codecharge.util.cache.CacheEvent,com.codecharge.util.cache.ICache,com.codecharge.template.*"%>
<%if ((new tbl_tipo_client_listServiceChecker()).check(request, response, getServletContext())) return;%>
<%@page contentType="text/html; charset=windows-1252"%>
<%@taglib uri="/ccstags" prefix="ccs"%>
<%--End JSP Page Init--%>

<%--Page Body @1-0E67ACB3--%>
<%@include file="tbl_tipo_client_listHandlers.jsp"%>
<%
    if (!tbl_tipo_client_listModel.isVisible()) return;
    ...
    pageContext.setAttribute("parent", tbl_tipo_client_listModel);
    pageContext.setAttribute("page", tbl_tipo_client_listModel);
    tbl_tipo_client_listModel.fireOnInitializeViewEvent(new Event());
    tbl_tipo_client_listModel.fireBeforeShowEvent(new Event());
    if (!tbl_tipo_client_listModel.isVisible()) return;
%>
<%--End Page Body--%>

<%--JSP Page Content @1-01FC89C8--%>
...
<%--JSP Page BeforeOutput @1-A0ECB710--%>
<%tbl_tipo_client_listModel.fireBeforeOutputEvent();%>
<%--End JSP Page BeforeOutput--%>

<%--JSP Page Unload @1-4F9A49EE--%>
<%tbl_tipo_client_listModel.fireBeforeUnloadEvent();%>
<%--End JSP Page Unload--%>
