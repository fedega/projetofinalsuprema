...
//feature binding @1-3050B41D
        public boolean check ( HttpServletRequest request, HttpServletResponse response, ServletContext context) {
            ...
            if ( "FlashChart1".equals ( attr ) ) {
                ...
                LongField urlView_desemprenho_aluguel_View_cod2 = new LongField(null, null);
                
                urlView_desemprenho_aluguel_View_cod2.setValue(request.getParameter("view_desemprenho_aluguel.View_cod2"));
                //FlashChart
                JDBCConnection ds = JDBCConnectionFactory.getJDBCConnection( "Conexao" );
                RawCommand command = new RawCommand( ds );

                command.setSql( "SELECT *  \n"
                            + "FROM (tbl_funcionario INNER JOIN view_desempenho_aluguel ON \n"
                            + "view_desempenho_aluguel.View_cod2 = tbl_funcionario.Cod_Funcionario AND view_desempenho_aluguel.View_cod2 = tbl_funcionario.Cod_Funcionario) INNER JOIN view_desempenho_venda ON \n"
                            + "view_desempenho_venda.View_cod = tbl_funcionario.Cod_Funcionario AND view_desempenho_venda.View_cod = view_desempenho_aluguel.View_cod2 AND view_desempenho_venda.View_cod = view_desempenho_aluguel.View_cod2 {SQL_Where} {SQL_OrderBy}" );
                String where1 = WhereParams.rawOperation( "tbl_funcionario.Cod_Funcionario", FieldOperation.EQUAL, urlView_desemprenho_aluguel_View_cod2, null, ds );
                ...
                if ( ! ds.hasErrors() ) {
                    ...
                    if (records.hasMoreElements()) {
                        ...
                        while (records.hasMoreElements()) {
                            ...
                            tmpl.setTag("main/Row", "@Alugados", ""+record.get("Alugados") );
                            tmpl.setTag("main/Row", "@Vendidos", ""+record.get("Vendidos") );
