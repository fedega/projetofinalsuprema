<%--JSP Page Init @1-24176879--%>
<%@page import="com.codecharge.*,com.codecharge.components.*,com.codecharge.util.*,com.codecharge.events.*,com.codecharge.db.*,com.codecharge.validation.*,java.util.*,java.io.*,com.codecharge.util.cache.CacheEvent,com.codecharge.util.cache.ICache,com.codecharge.template.*"%>
<%if ((new ManterVendaServiceChecker()).check(request, response, getServletContext())) return;%>
<%@page contentType="text/html; charset=windows-1252"%>
<%@taglib uri="/ccstags" prefix="ccs"%>
<%--End JSP Page Init--%>

<%--Page Body @1-EECC1106--%>
<%@include file="ManterVendaHandlers.jsp"%>
<%
    if (!ManterVendaModel.isVisible()) return;
    if (ManterVendaParent != null) {
        if (!ManterVendaParent.getChild(ManterVendaModel.getName()).isVisible()) return;
    }
    pageContext.setAttribute("parent", ManterVendaModel);
    pageContext.setAttribute("page", ManterVendaModel);
    ManterVendaModel.fireOnInitializeViewEvent(new Event());
    ManterVendaModel.fireBeforeShowEvent(new Event());
    if (!ManterVendaModel.isVisible()) return;
%>
<%--End Page Body--%>

<%--JSP Page Content @1-F247531C--%>
...
<%--JSP Page BeforeOutput @1-5CAA191A--%>
<%ManterVendaModel.fireBeforeOutputEvent();%>
<%--End JSP Page BeforeOutput--%>

<%--JSP Page Unload @1-B3DCE7E4--%>
<%ManterVendaModel.fireBeforeUnloadEvent();%>
<%--End JSP Page Unload--%>
