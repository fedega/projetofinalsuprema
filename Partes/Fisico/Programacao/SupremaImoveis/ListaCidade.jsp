<%--JSP Page Init @1-AE00C3AD--%>
<%@page import="com.codecharge.*,com.codecharge.components.*,com.codecharge.util.*,com.codecharge.events.*,com.codecharge.db.*,com.codecharge.validation.*,java.util.*,java.io.*,com.codecharge.util.cache.CacheEvent,com.codecharge.util.cache.ICache,com.codecharge.template.*"%>
<%if ((new ListaCidadeServiceChecker()).check(request, response, getServletContext())) return;%>
<%@page contentType="text/html; charset=windows-1252"%>
<%@taglib uri="/ccstags" prefix="ccs"%>
<%--End JSP Page Init--%>

<%--Page Body @1-19DEF5E2--%>
<%@include file="ListaCidadeHandlers.jsp"%>
<%
    if (!ListaCidadeModel.isVisible()) return;
    if (ListaCidadeParent != null) {
        if (!ListaCidadeParent.getChild(ListaCidadeModel.getName()).isVisible()) return;
    }
    pageContext.setAttribute("parent", ListaCidadeModel);
    pageContext.setAttribute("page", ListaCidadeModel);
    ListaCidadeModel.fireOnInitializeViewEvent(new Event());
    ListaCidadeModel.fireBeforeShowEvent(new Event());
    if (!ListaCidadeModel.isVisible()) return;
%>
<%--End Page Body--%>
...
<%--JSP Page BeforeOutput @1-3B1D1D95--%>
<%ListaCidadeModel.fireBeforeOutputEvent();%>
<%--End JSP Page BeforeOutput--%>

<%--JSP Page Unload @1-D46BE36B--%>
<%ListaCidadeModel.fireBeforeUnloadEvent();%>
<%--End JSP Page Unload--%>
