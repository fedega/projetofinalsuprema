<%--JSP Page Init @1-08A3E7B5--%>
<%@page import="com.codecharge.*,com.codecharge.components.*,com.codecharge.util.*,com.codecharge.events.*,com.codecharge.db.*,com.codecharge.validation.*,java.util.*,java.io.*,com.codecharge.util.cache.CacheEvent,com.codecharge.util.cache.ICache,com.codecharge.template.*"%>
<%if ((new ManterTipoDespServiceChecker()).check(request, response, getServletContext())) return;%>
<%@page contentType="text/html; charset=windows-1252"%>
<%@taglib uri="/ccstags" prefix="ccs"%>
<%--End JSP Page Init--%>

<%--Page Body @1-3D8F65DB--%>
<%@include file="ManterTipoDespHandlers.jsp"%>
<%
    if (!ManterTipoDespModel.isVisible()) return;
    if (ManterTipoDespParent != null) {
        if (!ManterTipoDespParent.getChild(ManterTipoDespModel.getName()).isVisible()) return;
    }
    pageContext.setAttribute("parent", ManterTipoDespModel);
    pageContext.setAttribute("page", ManterTipoDespModel);
    ManterTipoDespModel.fireOnInitializeViewEvent(new Event());
    ManterTipoDespModel.fireBeforeShowEvent(new Event());
    if (!ManterTipoDespModel.isVisible()) return;
%>
<%--End Page Body--%>
...
<%--JSP Page BeforeOutput @1-3B1260D4--%>
<%ManterTipoDespModel.fireBeforeOutputEvent();%>
<%--End JSP Page BeforeOutput--%>

<%--JSP Page Unload @1-D4649E2A--%>
<%ManterTipoDespModel.fireBeforeUnloadEvent();%>
<%--End JSP Page Unload--%>
